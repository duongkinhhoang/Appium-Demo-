...
//            caps.setCapability("appActivity", "com.touchboarder.androidapidemos.MainActivity");
    ...
    MobileElement viewLabel = driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout[2]/android.widget.RelativeLayout/android.widget.ListView/android.widget.TextView[13]");
    public void tap(MobileElement viewLabel ){
         new AndroidTouchAction(driver)
                 .tap(tapOptions().withElement(element(viewLabel)))
                 .perform();
    }
